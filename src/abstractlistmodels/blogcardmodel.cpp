...
void BlogCardModel::addThings(const QString Photolink,const QString Title, const QString Description)
{

    beginInsertRows(QModelIndex(),m_listBlogCardM.length(),m_listBlogCardM.length());
    m_listBlogCardM << QSharedPointer<BlogCardM>::create(Photolink,Title,Description);
    endInsertRows();
}
